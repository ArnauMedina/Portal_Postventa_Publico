...
class treseseinta(TypedDataFrame):
    ...
    schema = {
        ...
        'Agencia: Nombre / Razón Social':str,
        ...
        'Oportunidad: Fecha Venta Bruta': str,
        ...
        'Contrato Electricidad: Fecha Creación': str,
        'Contrato Electricidad: Fecha Inicio': str,
        'Contrato Electricidad: Fecha Fin': str,
        ...
        'Contrato Gas: Fecha Creación':str,
        'Contrato Gas: Fecha Inicio':str,
        'Contrato Gas: Fecha Fin':str,
        'IBAN':str,
        'Teléfono móvil':str,
        'PVPC':str,
        'CUR': str
